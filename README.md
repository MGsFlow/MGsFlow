<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=DIA%20Frontend&fontSize=70" />
</div>

<div align="center">
  <h3>🚀 창의적인 로직의 정점. 흥미로운 매력을 그리는 4년차 프론트엔드 개발자</h3>
</div>
...
- **프론트엔드 아키텍처**
  ...
  - 재사용 가능한 컴포넌트 라이브러리 구축 경험

- **렌더링 최적화 전략**
  - SSR(Server-Side Rendering) 구현으로 초기 로딩 성능 향상
  - CSR(Client-Side Rendering) 활용한 동적 인터랙션 구현
  - Next.js를 활용한 하이브리드 렌더링 전략 수립

- **성능 최적화**
  - 웹 성능 최적화 및 사용자 경험 개선
  - 번들 크기 최적화 및 로딩 성능 향상
  - Code Splitting과 Lazy Loading 전략 구현
  - 이미지 최적화 및 캐싱 전략 수립
...
- **신속한 유지보수 및 문제 해결**
  - 실시간 모니터링 및 신속한 이슈 대응
  - 체계적인 코드 리뷰와 품질 관리
  - 성능 병목 현상 분석 및 해결
  - 레거시 코드 리팩토링 경험

- **사용자 중심 개발**
  - CS 직무 경험을 통한 실제 사용자 니즈 파악
  - 사용자 피드백 기반 UX 개선 경험
...
### 🔄 상태 관리
- 📡 전역 상태 관리 아키텍처 설계
- 🔄 Zustand, Vuex 기반 상태 관리
- 📊 실시간 데이터 동기화 구현
- 🎯 상태 지속성 관리 및 최적화

### 🛠️ 개발 환경 및 도구
- 🧪 Jest 기반 단위/통합 테스트 구현

### 👥 협업 및 커뮤니케이션
- 📝 지라를 사용한 기술 문서 작성 및 유지보수
- 🔍 깃을 사용한 코드 리뷰 전략과 리뷰어 활동
- 💡 CS 경험 기반 사용자 니즈 분석
...
#### 실무용 git
<a href="https://github.com/MGflow"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FMGflow&count_bg=%23000000&title_bg=%23000000&icon=github.svg&icon_color=%23FFFFFF&title=GitHub&edge_flat=false"/></a>
